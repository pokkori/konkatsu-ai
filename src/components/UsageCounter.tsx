...
const STORAGE_KEY = 'konkatsu_usage';
const MAX_FREE = 3;
...
export function UsageCounter() {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-pink-50 border border-pink-200 text-sm text-gray-900" role="status" aria-label={`無料残り${remaining}回`}>
      <div className="flex-1">
        <div className="flex justify-between mb-1">
          <span className="text-xs text-gray-500">無料利用</span>
