    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-900">カード決済 — 婚活コーチAI</h2>
          <button
            onClick={onClose}
        ...
        <button
          ...
          className="w-full bg-pink-600 text-white font-bold py-3 rounded-xl hover:bg-pink-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors mt-4"
        >
          {loading ? "処理中..." : "支払う"}
        </button>
